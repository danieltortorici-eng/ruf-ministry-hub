...
function testServiceWorkerShape() {
  ...
  assert(html.includes('const APP_VERSION = "2026.07.22-calm-os-core-v42-ai-pilot.1"'), "deploy app declares the local v42 fictional AI pilot boundary");
  assert(serviceWorkerSource.includes('const CACHE_NAME = "ruf-ministry-hub-v94-calm-os-core-v42-ai-pilot.1"'), "service worker cache identity matches the local v42 fictional AI pilot app");
