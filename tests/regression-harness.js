...
function testServiceWorkerShape() {
  ...
  assert(html.includes('const APP_VERSION = "2026.07.22-calm-os-core-v42-ai-pilot.4"'), "deploy app declares the revalidated host-gated local v42 fictional AI pilot boundary");
  assert(serviceWorkerSource.includes('const CACHE_NAME = "ruf-ministry-hub-v97-calm-os-core-v42-ai-pilot.4"'), "service worker cache identity matches the revalidated host-gated local v42 fictional AI pilot app");
